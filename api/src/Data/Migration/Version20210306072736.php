 ...
 */
final class Version20210306072736 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE content (id UUID NOT NULL, content_json JSON DEFAULT NULL, content_html VARCHAR(255) DEFAULT NULL, content_img VARCHAR(255) DEFAULT NULL, content_file VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE mark (id UUID NOT NULL, content_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, coordinates JSON NOT NULL, options JSON DEFAULT NULL, PRIMARY KEY(id))');
