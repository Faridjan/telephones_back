 ...
 */
final class Version20210316162434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE content (id UUID NOT NULL, content_json TEXT DEFAULT NULL, content_html TEXT DEFAULT NULL, content_img VARCHAR(255) DEFAULT NULL, content_file VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE mark ADD CONSTRAINT FK_6674F27184A0A3ED FOREIGN KEY (content_id) REFERENCES content (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
